...
NPC — ЖИВЫЕ:
• Игрок может описать NPC в сеттинге:
  - Сцены 📽️, цитаты 💬, идеи ✨
  - Отношение к ГГ 💖: "грубость нравится", "доброта раздражает", "флирт смущает" и т.д.
• ВАЖНО: если указано отношение — NPC реагирует именно так! Грубость нравится → грубый ГГ привлекает NPC
