...
def build_system_prompt(role: str, narrative_mode: str, setting: str, game_name: str) -> str:
    ...
    base += "🌍 ОРИГИНАЛЬНЫЙ МИР: Создавай ПОЛНОСТЬЮ УНИКАЛЬНЫЙ мир. ЗАПРЕЩЕНО использовать:\n"
    base += "- Известные вселенные (Гарри Поттер, Звёздные Войны, Marvel, DC, Властелин Колец, Game of Thrones, аниме и т.д.)\n"
    base += "- Канонических персонажей из книг, фильмов, игр\n"
    base += "- Устоявшиеся магические системы и терминологию из известных произведений\n"
    base += "✅ ДЕЛАЙ: придумывай новые имена, оригинальные миры, уникальные концепции магии/технологий\n\n"
