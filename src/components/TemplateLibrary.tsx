...
АТМОСФЕРА: Роскошь и опасность. Шёлк и яд. Красота и жестокость. Акцент на психологических играх и моральных дилеммах.`
  },
  {
    ...
    setting: 'Современная Россия, элитное подразделение спецназа. В отряд спецназа прибывает новый боец — полицейский из городского отдела. На первый взгляд — катастрофа: неуклюжий, спотыкается на ровном месте, путает команды. Но именно эта "растяпистость" неожиданно спасает миссии: случайно запинается и находит тайник, роняет оружие — отвлекает противника. Отряд в шоке, но влюбляется в этого чудо-бойца. Игрок выбирает: суровый командир отряда, который против "любителей" в спецназе, или сам тот самый неуклюжий боец, доказывающий свою ценность через абсурдные ситуации.',
    description: 'Романтическая комедия в спецназе: неуклюжесть спасает миссии, любовь штурмует сердца.',
    icon: 'HeartHandshake',
