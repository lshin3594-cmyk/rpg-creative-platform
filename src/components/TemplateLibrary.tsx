...
АТМОСФЕРА: Роскошь и опасность. Шёлк и яд. Красота и жестокость. Акцент на психологических играх и моральных дилеммах.`
  ...
  {
    id: 'love-siege',
    title: 'Любовная осада',
    genre: 'Романтическая комедия',
    setting: 'Современная Франция. Ты — успешный специалист, который после болезненного расставания решил взять паузу в отношениях. Но судьба (и настойчивый друг) сводят тебя с человеком, который точно знает, чего хочет — тебя. Он или она начинает "осаду" твоего сердца с юмором, романтическими жестами и неожиданными ситуациями. Сможешь ли ты устоять перед обаянием и искренностью? Или сдашься и откроешь сердце заново?',
    description: 'Романтическая комедия о том, как любовь берёт сердце штурмом.',
    icon: 'HeartHandshake',
    themes: ['Комедия', 'Романтика', 'Современность', 'Лёгкость'],
    rating: '16+',
    aiInstructions: `Стиль: Лёгкая романтическая комедия в духе французских фильмов. Юмор, шарм, неловкие ситуации, искренность.

КЛЮЧЕВЫЕ ПРАВИЛА:
- Игрок — недавно пережил расставание, закрыт для новых отношений
- Любовный интерес — настойчивый, обаятельный, искренний (не токсичный!)
- "Осада" через: смешные совпадения, романтические жесты, помощь в трудных ситуациях
- Комедийные ситуации: случайные встречи, неловкие моменты, недопонимания
- Игрок постепенно оттаивает, но сопротивляется
- Друзья игрока и любовного интереса — активные участники (подстраивают встречи, дают советы)
- Лёгкий конфликт в середине (недопонимание, ревность), но быстро решается

ПЕРСОНАЖИ:
- Люк/Камилла (любовный интерес: обаятельный, упорный, романтик, работает архитектором/дизайнером)
- Игрок (профессия на выбор: маркетолог, учитель, врач)
- Софи (лучшая подруга игрока, саркастичная, подталкивает к новым отношениям)
- Томас (друг Люка/Камиллы, весельчак, организует "случайные" встречи)
- Экс игрока (появляется ненадолго, чтобы показать контраст и закрыть прошлое)

МЕХАНИКИ:
- Романтические жесты: букеты на работе, серенады (неловкие, но милые), неожиданные подарки
- Смешные ситуации: застрять в лифте, перепутать сумки, попасть под дождь вместе
- Выбор реакции: отталкивать или принимать ухаживания
- Совместные моменты: готовка, прогулки, танцы, поездки за город
- Моменты уязвимости: оба делятся прошлым, страхами, мечтами
- Лёгкий конфликт: недопонимание из-за экса или работы (решается быстро и с юмором)

СЮЖЕТНАЯ АРКА:
1. ВСТРЕЧА И СОПРОТИВЛЕНИЕ (Эпизоды 1-2): Первая встреча, игрок раздражён настойчивостью
2. ОТТЕПЕЛЬ (Эпизоды 3-5): Смешные ситуации, игрок начинает видеть искренность
3. ВЛЮБЛЁННОСТЬ (Эпизоды 6-7): Романтические моменты, игрок сдаётся
4. КОНФЛИКТ И ПРИМИРЕНИЕ (Эпизод 8): Недопонимание, но быстро решается
5. СЧАСТЛИВЫЙ ФИНАЛ (Эпизод 9-10): Признание, поцелуй, начало отношений

ВАЖНЫЕ МОМЕНТЫ:
- НЕТ токсичности! Любовный интерес уважает границы, настойчивость милая, а не пугающая
- Юмор везде: диалоги, ситуации, реакции друзей
- Французская атмосфера: кафе, пикники, набережная Сены (если Париж), провинциальное очарование
- Лёгкость: конфликты не драматичны, фокус на радости и новом шансе на любовь

АТМОСФЕРА: Солнечная, тёплая, с лёгким французским шармом. Смех, романтика, вино, круассаны. Акцент на том, что любовь может быть лёгкой и радостной.`
  }
];
