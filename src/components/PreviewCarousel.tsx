...
export const PreviewCarousel = () => {
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto rounded-2xl overflow-hidden backdrop-blur-xl bg-gradient-to-br from-purple-900/50 via-blue-900/40 to-black/70 border border-purple-500/40 shadow-2xl">
