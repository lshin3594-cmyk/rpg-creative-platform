// Скрипт для тестирования креативности ИИ
// Запуск: node run-creativity-tests.js
    ...
    game_settings: {
      ...
      initialCharacters: [
        ...
        },
        {
          ...
          description: "Восставший ангел, вытащил Дина из ада. Не понимает человеческих эмоций, учится у братьев Хельсинг.",
...
async function runAllTests() {
  ...
  if (passed === Object.keys(tests).length) {
    console.log('\n🎉 ВСЕ ТЕСТЫ ПРОЙДЕНЫ! ИИ готов к продакшену.');
  } else {
    console.log('\n⚠️ Требуется доработка промпта.');
  }
}
